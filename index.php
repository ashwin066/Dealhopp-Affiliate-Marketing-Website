...
if ($.urlParam('search') = '') {  // variable_name would be the name of your variable within your url following the ? symbol
    //execute if empty
} else {
 ...
 -->
                ...
                <div class="slider-container content has-scrollbar a_stickslider2">
                  ...
                  <a href="https://www.flipkart.com/" target="_blank">
                    <div class="slider-item">
                      <img src="https://rukminim1.flixcart.com/flap/1844/1400/image/f0ba4ffe837c8881.jpg" alt="-" class="banner-img">
                    </div>
                  </a>
                   <a  href="https://www.flipkart.com/" target="_blank">
                    <div class="slider-item">
                      <img src="https://rukminim1.flixcart.com/fk-p-flap/1844/1400/image/69a5dcc9c9549f01.jpg" alt="-" class="banner-img">
                    </div>
                  </a> 
                  <a href="https://amzn.to/3hxza44" target="_blank">
                    <div class="slider-item">
                      <img src="https://rukminim2.flixcart.com/flap/1800/1800/image/d47e9fe5365c0445.jpg" alt="-" class="banner-img">
                    </div>
                  </a>
                  <a  href="https://amzn.to/3PQAfRv" target="_blank">
                    <div class="slider-item">
                      <img src="https://rukminim2.flixcart.com/flap/1844/1400/image/743fe64aa6337316.png?q=50" alt="-" class="banner-img">
                    </div>
                  </a>
                  <a  href="https://www.flipkart.com/oppo-reno8-pro-5g-house-dragon-house-dragon-256-gb/p/itma4b519a4477a4?pid=MOBGKY54KCHFYFZW&otracker=clp_bannerads_1_13.bannerAdCard.BANNERADS_Oppo%2BReno8pro%2B5g%2BPreode_mobile-phones-big-saving-days-dec22-eidj8fs-store_VJD61YP7DX1T" target="_blank">
                    <div class="slider-item">
                      <img src="https://rukminim1.flixcart.com/fk-p-flap/1844/1400/image/a87c5508e24536f7.jpg" alt="-" class="banner-img">
                    </div>
                  </a> 
    ...
    -->
            <div class="product-container main_part">
              <div class="container p-2 mb-2 noselect showcase border-radius-11 border border-orange a_filter a_filter_sticky" id="filter">
       ...
       ?> </div>
           ...
           get_price_filter()      
            ?> </div>
              ...
              <div id="blobs-container" style="margin-top:-7px;" class="position-relative"> <?php get_titles(); ?> </div>
 ...
 -->
  ...
  <h6 style="color:grey;">Made with <i class="fa fa-heart heart text-danger"></i>
   & 
  <i class="fas fa-coffee heart text-danger"></i> by&nbsp;</h6>
   <a title="View my instagram"  href="https://www.instagram.com/ashwin_r66/" target="_blank" style="font-size: 1rem !important;text-transform:capitalize !important" class="footer-category-title"  >Ashwin R</a>
        ...
        <div class="container">
          ...
          <ul class="footer-nav-list">
            ...
            <li class="footer-nav-item flex">
              ...
              <a target="_blank" href="https://www.instagram.com/ashwin_r66/" class="footer-nav-link">Ashwin R</a>
            </li>
            <li class="footer-nav-item flex">
              <div class="icon-box">
                <ion-icon name="mail-outline"></ion-icon>
              </div>
              <a href="mailto:ashwinramesh660@Gmail.Com" class="footer-nav-link">ashwinramesh660@Gmail.Com</a>
            </li>
          </ul>
          <ul class="footer-nav-list">
            <li class="footer-nav-item">
      ...
      <div class="footer-bottom">
        <div class="container">
          ...
          <p class="copyright"> Copyright &copy; 
            <a href="https://www.instagram.com/ashwin_r66/">Dealhopp</a> all rights reserved. </p>
        </div>
      </div>
    </footer>
    <!--
