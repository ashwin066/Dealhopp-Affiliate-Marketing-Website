...
if(isset($_POST['insert_brand'])){
 ...
 if($number>0){
  ...
  $insert_query="insert into `brands` (brand_title,brand_logo) values ('$brand_title','$upload_logo')";
...
<div class="input-group w-10 mb-3">
  <input type="submit" class="mx-auto btn  a_btn" name="insert_brand" Value="Insert Brands" aria-describedby="basic-addon1">
