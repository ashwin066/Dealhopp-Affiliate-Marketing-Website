  ...
  <form method="post" enctype='multipart/form-data'>
    <div class="form-group">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="content_type" id="is_product_selected" value="0" checked />
    ...
    <div class="form-group">
      ...
      <input type="text" class="border-secondary a_category-item px-2" name="product_title" id="product_title" placeholder="Enter the title here...">
    </div>

    <div class="row product_input_field">
      <div class="form-group col-md-6">
        <label class="text-danger">Old Price</label>
        <input type="text" class="a_category-item px-2 border-danger" id="product_old_price" name="product_old_price" placeholder="Enter old price (MRP)">
      </div>
      <div class="form-group col-md-6">
        <label class="text-success">New Price</label>
        <input type="text" class="a_category-item px-2 border-success" id="product_price" name="product_price" placeholder="Enter new price (Offer price)">
      </div>
    </div>
    ...
    <div class="form-row coupon_input_field_field d-none">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="a_category-item px-2 border-success" id="coupon" name="coupon" placeholder="Enter Coupon Here">
      </div>
    </div>

    <div class="form-group">
      <label for="description">Description</label>
      <textarea type="textarea" class="w-100 a_category-item px-2 border-secondary" id="product_description" name="product_description" placeholder="Enter the description here..."></textarea>
    </div>
    ...
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" name="product_keywords" id="product_keywords" class="border-secondary a_category-item px-2" placeholder="Enter keywords ( Example: Mobile, Smartphone,etc. )" autocomplete="on">
      </div>

      <div class="form-group col-md-6 product_input_field">
        <label for="product_link " class="form-label"> Product Link</label>
        <input type="text" name="product_link" id="product_link" class="border-secondary a_category-item px-2" placeholder="Enter product link here..." autocomplete="off">
      </div>
    </div>
    ...
    <div class="form-row product_images_input">
      <div class="form-group col-md-4">
        ...
        <input type="text" class="a_category-item px-2 border-secondary" id="product_img1" name="product_img1" placeholder="Paste Product Image Link Here...">
      </div>
