...
if (isset($_POST['submit'])) {
    ...
    $is_coupon =  isset($_POST['is_coupon'])  ? $_POST['is_coupon'] : ($is_coupon != null ? $is_coupon : 0);
...
?> <div class="container a_category-item w-100 bg-light p-4 mb-5">
    ...
    <form method="post" enctype='multipart/form-data'>
        ...
        <div class="form-group">
            ...
            <input type="text" class="border-secondary a_category-item px-2" name="product_title" id="product_title" placeholder="Enter the title here..." value="<?php echo $product_title; ?>">
        </div>

        <div class="row product_input_field">
            <div class="form-group col-md-6">
                <label class="text-danger">Old Price</label>
                <input type="text" class="a_category-item px-2 border-danger" id="product_old_price" name="product_old_price" placeholder="Enter old price (MRP)" value="<?php echo $product_old_price; ?>">
            </div>
            <div class="form-group col-md-6">
                <label class="text-success">New Price</label>
                <input type="text" class="a_category-item px-2 border-success" id="product_price" name="product_price" placeholder="Enter new price (Offer price)" value="<?php echo $product_price; ?>">
            </div>
        </div>
        ...
        <div class="form-row coupon_input_field_field <?php echo ($is_coupon == 1) ? '' : 'd-none'; ?>">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="a_category-item px-2 border-success" id="coupon" name="coupon" placeholder="Enter Coupon Here" value="<?php echo $coupon; ?>">
            </div>
        </div>

        <div class="form-group">
            <label for="description">Description</label>
            <textarea type="textarea" class="w-100 a_category-item px-2 border-secondary" id="product_description" name="product_description" placeholder="Enter the description here..."><?php echo $product_description; ?></textarea>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="product_keywords" id="product_keywords" class="border-secondary a_category-item px-2" placeholder="Enter keywords ( Example: Mobile, Smartphone,etc. )" autocomplete="on" value="<?php echo $product_keywords; ?>">
            </div>

            <div class="form-group col-md-6 product_input_field">
                <label for="product_link " class="form-label"> Product Link</label>
                <input type="text" name="product_link" id="product_link" class="border-secondary a_category-item px-2" placeholder="Enter product link here..." autocomplete="off" value="<?php echo $product_link; ?>">
            </div>
        </div>
        ...
        <div class="form-row product_images_input product_input_field">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="a_category-item px-2 border-secondary" id="product_img1" name="product_img1" placeholder="Paste Product Image Link Here..." value="<?php echo $product_img1; ?>">
            </div>

            <div class="form-group col-md-4">
                <label for="product_img">Product Image 2(Optional)</label>
                <input type="text" class="a_category-item px-2 border-secondary" id="product_img2" name="product_img2" placeholder="Paste Product Image Link Here..." value="<?php echo $product_img2; ?>">
            </div>

            <div class="form-group col-md-4">
                <label for="product_img">Product Image 3(Optional)</label>
                <input type="text" class="a_category-item px-2 border-secondary" id="product_img3" name="product_img3" placeholder="Paste Product Image Link Here..." value="<?php echo $product_img3; ?>">
            </div>
        </div>
                    ...
                    if (isset($_POST['submit']))
                        if (!$number > 0)
                            if ($result) {
                                ...
                                // Alert will only show if $number > 0
