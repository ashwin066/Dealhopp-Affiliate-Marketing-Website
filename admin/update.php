...
//     move_uploaded_file($Product_img1_filetmp,$upload_image);
    ...
    $sql="update `products` set status='$status',product_keywords='$product_keywords',product_id=$product_id,Product_title='$Product_title',Product_old_price='$Product_old_price',Product_description='$Product_description',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_link='$product_link',product_price='$product_price' where product_id=$product_id";
...
id="product_link" class="form-control"
placeholder="Enter product link" autocomplete="off"
required="required" value="<?php echo $product_link;?>">
</div>
