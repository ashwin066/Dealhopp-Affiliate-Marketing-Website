...
?>
<div class="card bg-light w-100 p-4 mb-4">
    ...
    <form action="" method="post" class="mb-2" enctype='multipart/form-data'>
        ...
        <div class="input-group w-10 mb-3">
            <input type="submit" class="mx-auto btn a_btn" name="insert_cat" Value="Insert Category"
                aria-describedby="basic-addon1">

        </div>
    </form>
</div>
<!-- Table for Listing category -->
<div class="table-responsive">
    <table class="w-full table table-striped  text-center   ">
        ...
        <tbody>
            <?php get_brands_cat_for_admin(true) ?>
        </tbody>
