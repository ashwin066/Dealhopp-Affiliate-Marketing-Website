...
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@500&family=Lato:ital,wght@0,100;0,300;0,400;0,700;1,100;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <body>
  <button onclick="back_to_top_Function()" title="Go to top"><i id="back-to-top" class="fa-solid fa-angles-up"></i></button>


<?php include '../parts/admin-nav.php'?>
<div class="container">
<h5 class="text-center text-orange">Admin Panel <i class="text-dark fa-solid fa-user-tie"></i></h5>
 <div class="category d-flex justify-content-center mb-2">
...
<a href="index.php?insert_product" class="d-flex align-items-center flex-column a_tbn">
    <div class="a_category-item">
      ...
      <div class="category-img-box">
        <img src="https://cdn-icons-png.flaticon.com/128/1160/1160515.png" alt="dress & frock" width="30">
      </div>
